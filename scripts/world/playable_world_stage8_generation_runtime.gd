...
# Frozen Stage 8 runtime oracle. The public shipping runtime advances in later
# stages, but this file preserves the exact accepted six-ecology implementation.
