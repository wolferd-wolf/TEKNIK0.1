...
const STAGE6_DATA := preload("res://scripts/world/playable_world_stage6_tree_consistent_data.gd")
...
# the final accepted Stage 6 data/cache pair rather than the moving public
# runtime. The final Stage 6 data layer includes cache-aware lake/pond feature
# discovery plus water-aware tree-origin consistency.
func _init() -> void:
